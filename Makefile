...
programa: Main.o List.o Cancion.o PlayList.o DoubleList.o Archivo.o Pila.o
	gcc -o programa Main.o  DoubleList.o List.o PlayList.o Pila.o Archivo.o Cancion.o -lao -lmpg123 -lm 
